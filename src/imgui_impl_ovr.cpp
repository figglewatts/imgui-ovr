...
// TODO: remove GLFW references? i.e. make compatible with imgui_impl_glfw

// TODO: document global variables
...
static char         *g_GlslVersionString = "#version 330 core\n";
...
static glm::ivec2 g_VirtualCanvasSize = { 800, 600 }; // arbitrary default value
...
bool ImGui_ImplOvr_Init(GLFWwindow* window)
{
	g_Window = window;
	g_Time = 0.0;
...
void ImGui_ImplOvr_NewFrame()
{
	...
	// TODO(sam): update mouse pos and buttons

	// TODO(sam): gamepad mapping
}
...
bool ImGui_ImplOvr_CreateDeviceObjects()
{
	...
	const GLchar* quad_vertex_shader_with_version[2] = { g_GlslVersionString, quad_vert_shader };
	...
	const GLchar* quad_fragment_shader_with_version[2] = { g_GlslVersionString, quad_frag_shader };
